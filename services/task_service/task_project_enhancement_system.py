...
# File: services/task_service/task_project_enhancement_system.py
...
class TaskProjectEnhancementService:
    ...
    async def get_user_projects(self, user_id: int, status: Optional[ProjectStatus] = None,
        ...
        conditions = ["$1 = ANY(SELECT jsonb_array_elements_text(members->'user_id'::text) FROM projects) OR owner_id = $1"]
        params = [user_id]
        param_idx = 2
